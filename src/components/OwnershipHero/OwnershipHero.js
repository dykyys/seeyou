  ...
  return (
    <Section>
      <Container>
        ...
        <SectionTitleSub>
          SEEYOU will be partly user-owned. An equivalent of 10% of the original
          2.5 million shares will be gifted to active* users and recruiters
          during the first 25 months, starting from September 2022
        </SectionTitleSub>
        ...
        <OwnerUl>
          <ConferenceItem>
            ...
            <GlobalBox>
              ...
              <ConferenceDiscription>
                The shares are awarded as equity tokens. Tokens will be 100:1
                interchangeable with common shares. You can exchange 100 equity
          ...
          <ConferenceItem>
            ...
            <GlobalBox>
              ...
              <ConferenceDiscription>
                Starting from September 2022, one million tokens will be awarded
          ...
          <ConferenceItem>
            ...
            <GlobalBox>
              ...
              <ConferenceDiscription>
                ...
                coming by version 2.0 in February 2023. We are then also
                expanding to Linux and Chromebooks
              </ConferenceDiscription>
              <ConferenceDiscription>
                SEEYOU is only equitable if wholly free and truly global.
                Spreading the app around the world matters, and you will
                therefore get 10 Slices for every new user you recruit
              </ConferenceDiscription>
            </GlobalBox>
          </ConferenceItem>
          <ConferenceItem>
