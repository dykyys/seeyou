  ...
  return (
    <GlobalSection>
      ...
      <Box>
        ...
        <OurDiscription>
        <Light>COMMUNICATION</Light> Full transparency | Never sugar-coat the truth; we're not Willy Wonka | No truth-shaving, same message to all | Never announce new functionality before launch | No fortune-telling | No forward-looking statements | From November 2022, daily user growth in percent, as a 30-day moving average, and the daily number of users over the monthly number of users, also as a percentage, will be reported on the SEEYOU website.
        </OurDiscription>
